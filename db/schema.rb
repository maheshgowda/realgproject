...
ActiveRecord::Schema.define(version: 20160527064957) do
  ...
  create_table "spree_greeting_promotion_rules", force: :cascade do |t|
    t.integer "greeting_id"
    t.integer "promotion_rule_id"
  end

  add_index "spree_greeting_promotion_rules", ["greeting_id"], name: "index_greetings_promotion_rules_on_greeting_id"
  add_index "spree_greeting_promotion_rules", ["promotion_rule_id"], name: "index_greetings_promotion_rules_on_promotion_rule_id"
  ...
  create_table "spree_greetings", force: :cascade do |t|
    ...
    t.string   "greetingcard_picture_file_name"
    t.string   "greetingcard_picture_content_type"
    t.integer  "greetingcard_picture_file_size"
  ...
  add_index "spree_greetings", ["discontinue_on"], name: "index_spree_greetings_on_discontinue_on"
  add_index "spree_greetings", ["name"], name: "index_spree_greetings_on_name"
  add_index "spree_greetings", ["shipping_category_id"], name: "index_spree_greetings_on_shipping_category_id"
  add_index "spree_greetings", ["slug"], name: "index_spree_greetings_on_slug", unique: true
  add_index "spree_greetings", ["slug"], name: "permalink_idx_unique", unique: true
  add_index "spree_greetings", ["tax_category_id"], name: "index_spree_greetings_on_tax_category_id"
  ...
  add_index "spree_variants", ["greeting_id"], name: "index_spree_variants_on_greeting_id"
